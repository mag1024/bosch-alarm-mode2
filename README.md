...
- For Solution and AMAX panels, use both your automation code and your user code for authentication. The user code needs to have the "Master code functions" authority. 
