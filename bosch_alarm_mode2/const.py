...
BG_PANELS = {
    PANEL_MODEL[0x79], # D7412GV4
    PANEL_MODEL[0x84], # D9412GV4
    PANEL_MODEL[0xA8], # B3512 (US1B)
    PANEL_MODEL[0xA0], # B4512 (US1B)
    PANEL_MODEL[0xA4], # B5512 (US1B)
    PANEL_MODEL[0xA9], # B6512 (US1B)
    PANEL_MODEL[0xA6], # B8512G (US1A)
    PANEL_MODEL[0xA7], # B9512G (US1A)
}
